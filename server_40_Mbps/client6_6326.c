...
// #define TARGET_RATE_MBPS_2 10240000
// typedef struct 
// {
...
// }telemetry_t;
// static long target_rate_bps_2 = 10240000/8; 
...
//     struct timespec ts_sys6;

//      clock_gettime(CLOCK_REALTIME, &ts_sys6);

//     telemetry_t sending   ={.buffer="hi"};
//     // sending.timestamp = ts_sys6;
...
//          printf("%s\n",sending.buffer);
//     // printf("Timestamp sent: %lld seconds, %lld nanoseconds\n", (long long)ts_sys6.tv_sec, (long long)ts_sys6.tv_nsec);
...
#define BUFFER_SIZE 1024
#define TARGET_RATE_MBPS_5 10240000
typedef struct 
{
     struct timespec timestamp;
    char buffer[BUFFER_SIZE];  
...
static long target_rate_bps_5 = 10240000/8;  
